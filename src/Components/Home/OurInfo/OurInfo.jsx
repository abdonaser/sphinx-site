...
function OurInfo() {
  const svgString = `<svg width="1440" height="484" viewBox="0 0 1440 830" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <div
      className="ourInfo  content-end w-full  min-h-[480px] relative p-0 pb-10     flex items-end align-bottom"
      style={{
