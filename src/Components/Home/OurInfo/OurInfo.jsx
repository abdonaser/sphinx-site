...
function OurInfo() {
  ...
  return (
    <div
      className="ourInfo  content-end w-full  min-h-[550px] relative p-0 pb-2 border border-black    flex items-end align-bottom"
      style={{
        backgroundImage: `url(${encodedSvg})`,
        backgroundRepeat: "no-repeat",
        backgroundPosition: "bottom",
      }}>
      <div className="content-end mb-5 flex items-end align-bottom  ">
        <div className="parent-container flex flex-wrap sm:flex-nowrap flex-row justify-between items-start gap-[10px] sm:gap-5 ">
          {/* Main Info Section */}
          <div className="mainInfo w-[100%] sm:w-[30%] flex flex-col items-start ">
            ...
            <h3
              className={`text-[14px] sm:text-[18px] md:text-[22px] font-bold font-zain text-black
          ...
          <div className="impLinks w-[100%] sm:w-[30%]  md:pl-16">
            <h2 className="text-[18px] sm:text-[22px]  font-extrabold font-changa  text-secondary mb-4 ">
            ...
            <ul className="list-inside p-0 list-disc flex flex-wrap flex-row justify-between items-baseline sm:flex-col sm:items-start sm:justify-start md:pl-5">
              {mostLinks.map((link, index) => (
                <li
                  key={index}
                  className="hover:text-blue-600 cursor-pointer text-black font-medium font-changa text-[11px] sm:text-[18px]
          ...
          <div className="contactInfo w-full sm:w-1/3 md:pl-16">
            ...
            sm:flex-col sm:items-start gap-2 sm:justify-start w-[50%]  sm:w-full  ">
              {contacts.map((contact, index) => (
                <li
                  key={index}
                  className="flex items-center justify-center text-black font-medium font-changa text-[11px] sm:text-[18px] gap-[6px]">
                  <i className={`fas ${contact.icon} text-black `}></i>
...
export default SectionWrapper(OurInfo, "aboutUS");
